...
class Config(object):
    ...
    REDIS_URL = 'redis://:adminnews@localhost:6379/0'#os.environ.get('REDIS_URL') or 'redis://
    ...
    RQ_DASHBOARD_REDIS_URL = 'redis://:adminnews@localhost:6379/0'#os.environ.get('REDIS_URL') or 'redis://'
